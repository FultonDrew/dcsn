                                    ...
                                    function recommendations(){
                                        ...
                                        if (window.matchMedia("(max-width: 575px)").matches) {
                                          ...
                                          card.style.width = '25vw'
                                            ...
                                            directions.innerHTML = '<a href="https://www.google.com/maps/dir/?api=1&origin='+lat+","+long+"&destination="+interestedPlaces[i].geometry.viewport.na.j+","+interestedPlaces[i].geometry.viewport.ia.j+"&destination_place_id="+interestedPlaces[i].place_id+'" style="text-decoration:none; color:white">Directions</a>';
